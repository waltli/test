package com.sbolo.syk.common.inner.javassist;
...
import com.sbolo.syk.common.inner.ReflectionUtils;
...
public class JavassistBean {
	...
	public JavassistBean(List<JavassistField> fields) throws Exception {
		this("com.qzsoft.javassist", "Abc"+Math.random()*100, fields);
	}
	
	public JavassistBean(String className, List<JavassistField> fields) throws Exception {
		this("com.qzsoft.javassist", className, fields);
	}
